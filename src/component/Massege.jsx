...
function Massege({ msg, img, setMsg }) {
  ...
  return (
    <div
      className={` transform  z-20    bottom-16 md:bottom-12  md:left-10  flex flex-row h-16      left-[50%]  md:translate-x-0  -translate-x-1/2  md:translate-y-0 -translate-y-1/2   border-solid text-sm border-b-[1px]  border-main   rounded-xl shadow-lg fixed  ${
