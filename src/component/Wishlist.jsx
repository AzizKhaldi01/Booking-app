...
<p className=" text-gray-500 pt-2 text-sm">You can create, view, or edit wishlists once you’ve logged in.</p>
<Link className=" pt-3" to={'/login'}>
<button className=" px-6 p-3 bg-main rounded-lg text-white  font-medium">Login</button>
</Link>
</div>
  }
    </>
