...
function AccountMassge({Msg}) {
  ...
  return (
    <div className=  { `   ${ Msg == 'saved' ? ' opacity-100 z-20' :  ' opacity-0 -z-10'  }   absolute  justify-end pb-2 items-center top-1/2 flex-col  gap-1 flex left-1/2 transform -translate-x-1/2 -translate-y-1/2 h-[200px] w-[300px] bg-white  rounded-lg shadow-xl `} >
