...
function EditDate({setDopen , Dopen ,handelCancel , Savedate ,handleDateChange}) {
  ...
  >
    ...
    <div
      ...
      className={`  duration-300     left-[50%] flex fixed   h-[84%]  md:h-[75%] w-[90%]  lg:w-[50%]  pt-3   flex-col item-center   bg-white rounded-xl `}
    >
      ...
      <button onClick={ () => setDopen(!Dopen)} className=" border-[1px] border-solid  px-8 rounded-lg p-2">
          Cancel
        </button>
      ...
      <DemoContainer components={['DateRangeCalendar']}>
        <DateRangeCalendar    style={{      display:  'flex', flexDirection: isMobileView ? 'column' : 'row' }}     onChange={handleDateChange} />
      </DemoContainer>
